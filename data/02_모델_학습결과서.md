...
Random Forest는 GridSearchCV와 RandomizedSearchCV 결과를 구분해 정리한다.
...
MLP 관련 표의 빈칸은 `ML_deep.ipynb`에 값이 출력되지 않은 항목이다.
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Train |  |  |  |  |  |  |  |
| Validation | 0.5891 |  |  |  |  | 0.6946 |  |
| Test | 0.5880 |  |  |  | 0.4223 | 0.6745 | 0.5194 |
...
| MLP | 0.5880 |  | 0.4223 | 0.6745 | 0.5194 |
